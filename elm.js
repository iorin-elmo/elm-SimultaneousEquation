...
var $author$project$Main$randint = function () {
	var rangeMin = -15;
	var rangeMax = 15;
	return A2($elm$random$Random$int, rangeMin, rangeMax);
}();
	...
	function (msg, model) {
		switch (msg.$) {
			case 'GetValues':
				...
				var mat = _v1.a;
				var v = _v1.b;
				return (!$author$project$SimultaneousEquation$determinate(mat)) ? _Utils_Tuple2(
					model,
					A2(
						$elm$random$Random$generate,
						$author$project$Main$GetValues,
						A2($elm$random$Random$pair, $author$project$Main$randMatrix, $author$project$Main$randVec2))) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var $author$project$SimultaneousEquation$fraction2String = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
...
var $author$project$SimultaneousEquation$viewEquation = F2(
	function (_v0, _v3) {
		var _v1 = _v0.a;
		var x1 = _v1.a;
		var x2 = _v1.b;
		...
		return _List_fromArray(
			[
				A3($author$project$SimultaneousEquation$viewEquationHelper, x1, y1, v1),
				A3($author$project$SimultaneousEquation$viewEquationHelper, x2, y2, v2)
			]);
	});
